...
const uint16_t note_fns[] = {
    0, 0x3D, 0x07D, 0x0C2, 0x10A, 0x157, 0x1a8, 0x1fe, 0x25a, 0x2ba, 0x321, 0x38d};

int8_t melody[] = {
    NOTE_E4, NOTE_E4, NOTE_NUL, NOTE_E4,
    NOTE_NUL, NOTE_C4, NOTE_E4, NOTE_NUL,
    NOTE_G4, NOTE_NUL, NOTE_NUL, NOTE_NUL,
    NOTE_G4, NOTE_NUL, NOTE_NUL, NOTE_NUL,

    NOTE_C4, NOTE_NUL, NOTE_NUL, NOTE_G4,
    NOTE_NUL, NOTE_NUL, NOTE_E4, NOTE_NUL,
    NOTE_NUL, NOTE_A4, NOTE_NUL, NOTE_B4,
    NOTE_NUL, NOTE_A4D, NOTE_A4, NOTE_NUL,

    NOTE_G4, NOTE_E4, NOTE_G4,
    NOTE_A4, NOTE_NUL, NOTE_F4, NOTE_G4,
    NOTE_NUL, NOTE_E4, NOTE_NUL, NOTE_C4,
    NOTE_D4, NOTE_B4, NOTE_NUL, NOTE_NUL,
