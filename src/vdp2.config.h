...
#define NGB1_PATTERN_ADDR (VDP2_VRAM_ADDR(0, 0x00000))
#define NBG1_CELL_ADDR (VDP2_VRAM_ADDR(0, 0x02000))
#define NBG1_COLOR_ADDR (VDP2_CRAM_MODE_0_OFFSET(0, 0, 0))

#define NGB0_PATTERN_ADDR (VDP2_VRAM_ADDR(3, 0x04000)) // 0x4000 used
